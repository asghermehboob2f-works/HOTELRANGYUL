// ============================================
// HOTEL RANGYUL PAGE JAVASCRIPT
// Complete booking system with WhatsApp integration
// ============================================

document.addEventListener('DOMContentLoaded', function() {
    console.log('Hotel Rangyul page loaded');
...
function sendToWhatsApp(name, phone, checkIn, checkOut, nights, guests, room, price) {
    ...
    let message = `*🏨 Hotel Rangyul - Booking Request*%0A%0A`;
    ...
    message += `_This booking request was sent from Hotel Rangyul website_`;
...
window.addEventListener('load', function() {
    console.log('Hotel Rangyul page fully loaded');
});
